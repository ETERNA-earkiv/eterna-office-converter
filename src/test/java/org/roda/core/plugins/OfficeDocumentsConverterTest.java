...
public class OfficeDocumentsConverterTest {
        ...
        private static final Logger LOGGER = LoggerFactory.getLogger(OfficeDocumentsConverterTest.class);
        ...
        public void setUp() throws Exception {
                ...
                URL corporaURL = OfficeDocumentsConverterTest.class.getResource("/corpora/Office");
                ...
                // Create an AIP
                DefaultStoragePath aipPath = DefaultStoragePath.parse(RodaConstants.STORAGE_CONTAINER_AIP);
                aip = model.createAIP(
                                null,
                                storage,
                                aipPath,
        ...
        public void testOfficeDocumentsConverter_PDF_StrictValidation()
                ...
                IndexResult<IndexedAIP> aipResult = index.find(
                                IndexedAIP.class,
                                aipFilter,
                                null,
                                new Sublist(0, 1),
                ...
                IndexResult<IndexedFile> sourceFiles = index.find(
                                IndexedFile.class,
                                fileFilter,
                                null,
                                new Sublist(0, 100),
                 ...
                 * -------------------------------
                 */
                List<String> sourceFileIds = sourceFiles.getResults()
                                .stream()
                                .map(IndexedFile::getUUID)
                                .toList();

                SelectedItemsList<IndexedFile> selectedFiles = SelectedItemsList.create(IndexedFile.class,
                                sourceFileIds);
                ...
                IndexResult<IndexedRepresentation> preservationReps = index.find(
                ...
                for (IndexedRepresentation presRep : preservationReps.getResults()) {
                        ...
                        IndexResult<IndexedFile> pdfs = index.find(
                                        IndexedFile.class,
                                        pdfFilter,
                                        null,
                                        new Sublist(0, 100),
                 ...
                 * -------------------------------
                 */
                List<String> convertedIds = convertedFiles.stream()
                                .map(IndexedFile::getUUID)
                                .toList();
